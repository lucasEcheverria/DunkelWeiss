...
class CommunityServiceTest {
    ...
    class GetAll {
        ...
        @Test
        void returnsEmptyList_whenNoCommunitiesExist() {
        ...
        @Test
        void returnsMappedDTOs_whenCommunitiesExist() {
    ...
    class CreateCommunity {
        ...
        @Test
        void throwsIllegalArgument_whenTokenIsInvalid() {
        ...
        @Test
        void savesAndReturnsCommunityDTO_whenTokenIsValid() {
        ...
        @Test
        void addsCreatorToCommunitiesList_whenTokenIsValid() {
            User user       = buildUser(1, "user@test.com", "tester");
            Community saved = buildCommunity(10, "Gaming", null);
    ...
    @Nested
    class GetTop5ByPopularity {

        @Test
        void returnsMappedDTOs_inOrder() {
        ...
        @Test
        void returnsEmptyList_whenNoCommunities() {
    ...
    class GetUserCommunities {
        ...
        @Test
        void returnsUserCommunities_whenTokenIsValid() {
        ...
        @Test
        void returnsEmptyList_whenUserHasNoCommunities() {
            User user = buildUser(1, "u@test.com", "u");
    ...
    class LeaveCommunity {
        ...
        @Test
        void throwsIllegalArgument_whenCommunityDoesNotExist() {
            User user = buildUser(1, "u@test.com", "u");
        ...
        @Test
        void removesCommunityFromUserAndSaves() {
        ...
        @Test
        void doesNotSave_whenUserIsNotMemberOfCommunity() {
            Community comm = buildCommunity(5, "Tech", null);
            User user      = buildUser(1, "u@test.com", "u");
